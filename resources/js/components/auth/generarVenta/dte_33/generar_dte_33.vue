        ...
        <b-card class="text-center transparencia">
          <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-4 text-right">
              <b-card>
                <b-form-group id="cliente" label="Datos del cliente:">
                  <div class="row">
                    <div class="col-12">
                        <label for="">Rut:</label>
                        <b-input-group>
                      ...
                      <div class="text-left my-1" style=" padding:3px;border-radius:4px; border:1px solid #D5DBDB" v-if="ver_cliente">
                          <label><b>Rut: </b> {{mostrar_cliente.rut}}</label> <br>
                          <label><b>Razón social: </b> {{mostrar_cliente.razon_social}}</label> <br>
                          <label><b>Dirección: </b> {{mostrar_cliente.direccion}}</label> <br>
                          <label><b>Comuna: </b> {{mostrar_cliente.comuna}}</label> <br>
                          <label><b>Ciudad: </b> {{mostrar_cliente.ciudad}}</label> <br>
                          <label><b>Contacto: </b>{{mostrar_cliente.contacto}}</label> <br>
                          ...
                          <!-- <p><label><b>Giro: </b> <input class="" :value="mostrar_cliente.giro" type="text"></label></p> <br> -->
